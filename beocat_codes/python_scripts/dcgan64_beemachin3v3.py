...
path = "dataset_2/training/Bombus_borealis/"
...
def generate_and_save_images(model, epoch, test_input):
  ...
  for i in range(predictions.shape[0]):
      ...
      #plt.axis('off')
      if epoch % 500 == 0:      
         plt.savefig('generated_images_borealis/image_at_epoch_{:04d}.png'.format(epoch))
  plt.show()
...
discriminator.save('saved_models_dcgan/discriminator_model_borealis_{}.h5'.format(time_saved))
generator.save('saved_models_dcgan/generator_model_borealis_{}.h5'.format(time_saved))

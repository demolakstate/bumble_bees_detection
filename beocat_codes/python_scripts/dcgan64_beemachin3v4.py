...
base_path = "dataset_2/training/"
specie_names = os.listdir(base_path)
...
BUFFER_SIZE = 5
BATCH_SIZE = 1
def process_train_images(specie_name):
  specie_path = os.listdir(os.path.join(base_path, specie_name))
  train_images = np.array(os.listdir(specie_path))
  ...
  return (train_images,specie_path)

train_images_list = defaultdict(list)

for index,specie_name in enumerate(specie_names):
  tr_images, sp_path = process_train_images(specie_name)
  train_images_list[index].append([sp_path, tr_images])
...
discriminator.summary() # print the summary of discriminator
...
def train_step(images):
    ...
    for file_name in images:
        new_pic = load_image( train_images_list[0][0] + file_name)
...
# Commented out IPython magic to ensure Python compatibility.
# %%time
train(train_images_list[0], EPOCHS)

...
path = "dataset_2/training/Bombus_citrinus/"
...
BUFFER_SIZE = 1160#200000 # number of images in training i think
BATCH_SIZE = 8#500 # This is just the standard number for batch size. Google for more info
...
def generate_and_save_images(model, epoch, test_input):
  ...
  for i in range(predictions.shape[0]):
      ...
      #plt.axis('off')
      if epoch % 500 == 0:      
         plt.savefig('generated_images_citrinus/image_at_epoch_{:04d}.png'.format(epoch))
  plt.show()
...
discriminator.save('saved_models_dcgan/discriminator_model_citrinus_{}.h5'.format(time_saved))
generator.save('saved_models_dcgan/generator_model_citrinus_{}.h5'.format(time_saved))

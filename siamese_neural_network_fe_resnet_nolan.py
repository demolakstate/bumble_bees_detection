...
dir = "/data/okerinde/projects/beemachine/dataset_2/training"
#dir = "/homes/okerinde/projects/beemachine/dataset_3/training"
dir_test = '/data/okerinde/projects/beemachine/test_dataset_2/test'
...
#pairs_val, labels_val = create_pairs(image_batches_val[-1], labels_batches_val[-1], 21)
...
checkpoint_path = 'checkpoint_siamese_nn_fe_resnet/cp.ckpt'
...
predictions = model.predict_on_batch([val_pairs[:, 0][:], val_pairs[:, 1][:]])
...
#plt.legend()
#plt.savefig('plt_fe.png', dpi=300, bbox_inches='tight')
# Save the model
